...
EXPECTED = {
    ...
    "phase_c_source_commit": "e63ebd80e5fa4f712a1a7cf590ec74c116768873",
    "dataset_sha256": "4b8e2d9be794584fad232bcc46cf78c2c4f422efb3e0642f503c8a77fcd2e8ec",
    "phase_c_pretrained_checkpoint_sha256": "7ae44f773b3f5fe36579c4101542e495119cf6e348f622f5edbfedaa2855a46c",
    "phase_c_selected_checkpoint_sha256": "ab6ce3c39671554ef114234c464f23cc18828ea751a4bbb5547beb59793c1b54",
...
def verify_manifest() -> int:
    ...
    phase_c_recipe = load_json(ROOT / "configs" / "recipe.json")
    ...
    identity_checks = {
        ...
        "phase C source commit": (
            phase_c_recipe["source_git_commit"],
            EXPECTED["phase_c_source_commit"],
        ),
        "phase C recipe dataset hash": (
            phase_c_recipe["demo_reference"]["dataset_sha256"],
            EXPECTED["dataset_sha256"],
        ),
        "data pointer hash": (pointer["sha256"], EXPECTED["dataset_sha256"]),
        "B1 recipe checkpoint hash": (
        ...
        "packaged Phase C pretrained checkpoint": (
            sha256_file(ROOT / "checkpoints" / "low7_pretrained_checkpoint.pt"),
            EXPECTED["phase_c_pretrained_checkpoint_sha256"],
        ),
        "packaged Phase C selected checkpoint": (
            sha256_file(ROOT / "checkpoints" / "phase_c_selected_r25.pt"),
            EXPECTED["phase_c_selected_checkpoint_sha256"],
        ),
        "packaged B1 pretrained checkpoint": (
            sha256_file(ROOT / "checkpoints" / "b1_balanced_pretrained.pt"),
            EXPECTED["pretrained_checkpoint_sha256"],
        ),
        "packaged B1 selected checkpoint": (
    ...
    for markdown in (ROOT / "README.md", ROOT / "CODE_INDEX.md", ROOT / "B1_CURRENT_BEST.md"):
